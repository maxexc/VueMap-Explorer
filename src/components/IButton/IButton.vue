...
const bgStyle = computed(() => {
  switch (props.variant) {
    ...
    case 'mobile':
      return 'bg-gradient-to-r from-secondary to-primary text-white w-full rounded-xl py-2 px-4 sm:px-2 lg:px-6 font-bold text-sm sm:text-xs lg:text-base hover:shadow-md transition-all'
    case 'modal':
